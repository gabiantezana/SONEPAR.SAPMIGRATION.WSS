...
namespace SONEPAR.SAPMIGRATION.WSS.MODEL
{
    ...
    public partial class OCRD
    {
        ...
        public string U_RX_GRUCLI { get; set; }
        public string U_RX_FMXUSR { get; set; }
        public Nullable<System.DateTime> U_RX_FECANI { get; set; }
        public Nullable<System.DateTime> U_RX_FECCRE { get; set; }
        public string U_RX_SECECO { get; set; }
        public string U_RX_PTODEC { get; set; }
        public string U_RX_ENVAVI { get; set; }
        public string U_RX_CONPAG { get; set; }
        public string U_RX_FICCLI { get; set; }
        public string U_RX_DJRENT { get; set; }
        public string U_RX_PDTCLI { get; set; }
        public string U_RX_FICRUC { get; set; }
        public string U_RX_DNIREP { get; set; }
        public string U_RX_FACPRO { get; set; }
        public string U_RX_NROTOP { get; set; }
        public string U_RX_GRUCL1 { get; set; }
        public string U_RX_SNRANKING { get; set; }
        public string U_RX_SNTIPO { get; set; }
        public Nullable<decimal> U_RX_SNFACPROM { get; set; }
        public string U_RX_SNGRUPECO { get; set; }
        public string U_EXX_TIPVINECO { get; set; }
        public string U_RX_GRUSON { get; set; }
        public string U_RX_CLSSON { get; set; }
        public string U_RX_SGMSON { get; set; }
        public string U_EXX_FE_PROEST { get; set; }
        public string U_EXX_FE_NROEXP { get; set; }
        public string U_EXX_FE_CODUNE { get; set; }
        public string U_EXX_FE_PROSEL { get; set; }
        public string U_EXX_FE_CON { get; set; }
    }
}
