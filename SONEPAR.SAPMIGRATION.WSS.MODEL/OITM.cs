...
namespace SONEPAR.SAPMIGRATION.WSS.MODEL
{
    ...
    public partial class OITM
    {
        ...
        public string U_RX_LINPRO { get; set; }
        public string U_RX_GRUPRO { get; set; }
        public string U_RX_SBGPRO { get; set; }
        public string U_RX_FAMPRO { get; set; }
        public string U_RX_MRCPRO { get; set; }
        public string U_RX_SBMPRO { get; set; }
        public Nullable<int> U_RX_DIAENT { get; set; }
        public Nullable<decimal> U_RX_PSPFER { get; set; }
        public Nullable<decimal> U_RX_PSPMOS { get; set; }
        public string U_RX_PROMOC { get; set; }
        public string U_RX_CODVYF { get; set; }
        public string U_RX_CODDIR { get; set; }
        public string U_RX_DSCACU { get; set; }
        public string U_RX_CODIGO { get; set; }
        public string U_RX_CODAMP { get; set; }
        public string U_EXX_CUBSO { get; set; }
        public Nullable<decimal> U_EXX_SIPEAN { get; set; }
        public string U_EXX_TIPDEP { get; set; }
        public Nullable<decimal> U_EXX_PORDEP { get; set; }
        public string U_EXX_ESTADO { get; set; }
        public string U_EXX_TIPAF { get; set; }
        public string U_EXX_LEASING { get; set; }
        public string U_EXX_LEANROCON { get; set; }
        public Nullable<System.DateTime> U_EXX_LEAFECCON { get; set; }
        public Nullable<System.DateTime> U_EXX_LEAFECINI { get; set; }
        public Nullable<decimal> U_EXX_LEANROCUO { get; set; }
        public Nullable<decimal> U_EXX_LEAMONTOT { get; set; }
        public Nullable<decimal> U_EXX_VIDEAC { get; set; }
        public string U_EXX_INTANG { get; set; }
        public Nullable<decimal> U_EXX_AFVALME { get; set; }
        public Nullable<decimal> U_EXX_AFTCADQ { get; set; }
        public string U_EXX_TIPOEXIS { get; set; }
        public string U_EXX_TIPOUMED { get; set; }
        public string U_EXX_GRUPOPER { get; set; }
        public string U_EXX_ISCFASE { get; set; }
        public string U_EXX_ISCUND { get; set; }
        public Nullable<decimal> U_EXX_ISCEQU { get; set; }
        public Nullable<decimal> U_EXX_ISCIMP { get; set; }
        public string U_EXX_TransId { get; set; }
        public string U_EXX_Anulado { get; set; }
